...
import (
	...
	memberaddress "micro/api/internal/handler/member/address"
	membergrowthchangehistory "micro/api/internal/handler/member/growthchangehistory"
	memberintegrationchangehistory "micro/api/internal/handler/member/integrationchangehistory"
	memberintegrationconsumesetting "micro/api/internal/handler/member/integrationconsumesetting"
	memberlevel "micro/api/internal/handler/member/level"
	memberloginlog "micro/api/internal/handler/member/loginlog"
	membermember "micro/api/internal/handler/member/member"
	memberrulesetting "micro/api/internal/handler/member/rulesetting"
	memberstatistics "micro/api/internal/handler/member/statistics"
	membertag "micro/api/internal/handler/member/tag"
	membertask "micro/api/internal/handler/member/task"
	ordercart "micro/api/internal/handler/order/cart"
	ordercompayaddress "micro/api/internal/handler/order/compayaddress"
	orderoperatehistory "micro/api/internal/handler/order/operatehistory"
	orderorder "micro/api/internal/handler/order/order"
	orderreturnapply "micro/api/internal/handler/order/returnapply"
	orderreturnreason "micro/api/internal/handler/order/returnreason"
	ordersetting "micro/api/internal/handler/order/setting"
	productbrand "micro/api/internal/handler/product/brand"
	productcategory "micro/api/internal/handler/product/category"
	productcomment "micro/api/internal/handler/product/comment"
	productfeighttemplate "micro/api/internal/handler/product/feighttemplate"
	productmemberprice "micro/api/internal/handler/product/memberprice"
	productproduct "micro/api/internal/handler/product/product"
	productskustock "micro/api/internal/handler/product/skustock"
	smscoupon "micro/api/internal/handler/sms/coupon"
	smscouponhistory "micro/api/internal/handler/sms/couponhistory"
	smsflashpromotion "micro/api/internal/handler/sms/flashpromotion"
	smsflashpromotionlog "micro/api/internal/handler/sms/flashpromotionlog"
	smsflashpromotionsession "micro/api/internal/handler/sms/flashpromotionsession"
	smshomeadvertise "micro/api/internal/handler/sms/homeadvertise"
	smshomebrand "micro/api/internal/handler/sms/homebrand"
	smshomenewproduct "micro/api/internal/handler/sms/homenewproduct"
	smshomerecommendproduct "micro/api/internal/handler/sms/homerecommendproduct"
	smshomerecommendsubject "micro/api/internal/handler/sms/homerecommendsubject"
	sysconfig "micro/api/internal/handler/sys/config"
	sysdept "micro/api/internal/handler/sys/dept"
	sysdict "micro/api/internal/handler/sys/dict"
	sysjob "micro/api/internal/handler/sys/job"
	syslog "micro/api/internal/handler/sys/log"
	sysmenu "micro/api/internal/handler/sys/menu"
	sysrole "micro/api/internal/handler/sys/role"
	sysuser "micro/api/internal/handler/sys/user"
